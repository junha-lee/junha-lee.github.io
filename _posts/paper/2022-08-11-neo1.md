...
![image-20220222015045145](../../assets/images/2022-08-11-OD/Screen_Shot_2022-08-08_at_12.54.17_PM.png)
...
1. PASCAL VOC 07/12
   ...
   ![image-202202220150451456](../../assets/images/2022-08-11-OD/untitled.png)
   ...
   - 클래스별 데이터수
     ...
     ![image-20220222015045145](../../assets/images/2022-08-11-OD/untitled 1.png)

2. ILSVRC

   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 2.png)

   - ILSVRC는 The ImageNet Large Scale Visual Recognition Challenge 에서 사용된 데이테셋으로, 2010년에서 2017까지 진행됨.
   - 클래스 별 데이터 수

   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 3.png)
...
3. MS-COCO
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 4.png)
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 5.png)

4. Open Image

   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled.png) 6

- google이 2017년에 구성한 데이터셋으로, 가장 크며, 이미지당 객체 수도 가장 많음.
- 클래스별 데이터 수

![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 7.png)

![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 8.png)
...
1. Issues of Data Skew/Bias
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 9.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 10.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 11.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 12.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 13.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 14.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 15.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 16.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 17.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 18.png)

with와, depth, resoution은 서로 긴밀히 연관되어있으며, 이들을 같이 키우는 것이 자원을 효율적으로 사용하며, 성능이 더 좋다는 것을 증명

![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 19.png)

실제 다른 모델들과 efficentnet들을 비교한 결과, 대부분 기존 모델들보다 효율적이며, 8.4배 적은 연산량으로 더 높은 정확도를 갖는 모델도 존재

![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 20.png)
...
1. Viola-Jones
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 21.png)
...
1. R-CNN
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 22.png)
...
2. SPP-Net
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 23.png)
...
3. Fast R-CNN
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 24.png)
...
4. Faster R-CNN
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 25.png)
...
5. FPN
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 26.png)
...
1. YOLO
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 27.png)
...
2. SSD
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 28.png)
...
3. YOLOv2 and YOLO9000
   ...
   2. contribution
      ...
      ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 29.png)
...
5. YOLOv3
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 30.png)
...
6. CenterNet
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 31.png)

   1. 한 점 (center point)과 물체의 사이즈, offset을 output으로 하여 예측 object detection 뿐만 아니라 3D detection, pose estimation에서도 활용

7. EfficientDet

   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 32.png)
...
8. Swin  Transformer
   ...
   ![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 33.png)
...
![image-20220222015045145](../../assets/images/2022-08-11-OD\untitled 34.png)
